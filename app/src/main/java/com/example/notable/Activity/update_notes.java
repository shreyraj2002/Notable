...
public class update_notes extends AppCompatActivity {
    ...
    private void UpdateNotes(String title, String subtitle, String notes) {
        ...
        Notes_DB updateNotes = new Notes_DB();
        updateNotes.id = iid;
        updateNotes.notesTitle = title;
        updateNotes.notesSubtitle = subtitle;
        updateNotes.notesData = sequence.toString();      //notes Date
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (item.getItemId() == R.id.ic_delete) {
            BottomSheetDialog sheetDialog = new BottomSheetDialog(update_notes.this,R.style.BottomSheetStyle);

            View view = LayoutInflater.from(update_notes.this).
